...
export_predprey <- function(direction,
                            workspace_root = file.path("tools", "oracle", "parity",
                                                       "workspaces"),
                            bundle_root = file.path("tools", "oracle", "parity",
                                                    "datasets"),
                            report_dir = file.path("tools", "oracle", "parity",
                                                   "reports")) {
...
run_predprey_parity <- function(directions = c(1L, 2L), export = TRUE,
                                out = file.path("tools", "oracle", "parity", "reports",
                                                "parity_predprey.csv")) {
