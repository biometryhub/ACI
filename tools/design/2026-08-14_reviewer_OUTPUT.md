...
`tools/design/2026-08-14_reviewer_brief.md`. The brief asked for a one-to-one
...
`tools/design/artefacts/2026-08-14_cir_residual_rows.csv`, produced by
`tools/design/artefacts/2026-08-14_reviewer_probe.R`.
...
online-smoother cairns, `tools/oracle/parity/reports/PARITY_REPORT.md`,
`matlab_reference/simps.m`, the CIR block of `dyad_interaction_model.m`
(lines 433–561), and `tools/oracle/aci_oracle_cir.m`.
...
* A dedicated probe
  (`tools/design/artefacts/2026-08-14_reviewer_probe.R`) that transcribes
...
Writes `tools/design/artefacts/2026-08-14_cir_residual_rows.csv` (751 reported
