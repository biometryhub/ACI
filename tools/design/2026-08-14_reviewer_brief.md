...
A harness under `tools/oracle/parity/` hoists the authors' computational passages into
...
Reproduce: `tools/oracle/parity/tools/`, driven from R; needs MATLAB and a clone of
...
- The ENSO simulation uses a Milstein correction whose derivation is unclear;
  documented at `tools/design/2026-08-13_milstein_anomaly.md`, unresolved.
