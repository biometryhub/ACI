...
- `oracle/parity/manifest/knobs.dcf` -- `predprey_dir1`, `predprey_dir2`
- `oracle/parity/tools/reduce.R` -- section composition and its assertions
- `oracle/parity/reports/regrade_predprey_dir1.csv`, `..._dir2.csv`
