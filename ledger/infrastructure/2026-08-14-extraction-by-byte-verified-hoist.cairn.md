...
**1. Keep the existing hand-transcribed harnesses** in `oracle/aci_oracle_*.m`
...
- `oracle/parity/manifest/extracts.dcf` -- declared ranges, inputs, outputs
- `oracle/parity/tools/extract.R` -- generator and byte checker
- `oracle/parity/tools/gate.R`, `oracle/parity/matlab/bitcompare.m` -- gate G1
- `oracle/parity/reports/g1_small.csv`, `g1_tiny.csv` -- 58/58 at difference 0
