...
(`oracle/parity/`). The gold side of gate G1 is a workspace captured from the
...
- `oracle/parity/manifest/knobs.dcf` -- the declared substitutions and their
  justifications
- `oracle/parity/tools/reduce.R` -- the minimality assertions
- `oracle/parity/matlab/check_profile.m` -- the degeneracy gate
