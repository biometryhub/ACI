## acir reserve file
## Origin: aci/R/formula_interface.R:1-610
## Source package: aci 0.0.30, git tree 97f6b124
## Category: extensions
## Intended release: unscheduled (package-only, no paper or MATLAB backing)
## Reason: aci_fit formula front-end and its generics; package-only, no paper or MATLAB backing. The three engine plot methods at aci formula_interface.R:613-674 are NOT here: they moved to the acir mainline as R/plots.R.
